                    ...
                    <div key={block.number} className="d-flex flex-column">
                      <div className="media-body mb-0 d-flex" style={{paddingTop:1}}>
                        <div className="text-left">
                          <Link className= "mr-1 d-flex justify-content-start color-litetokens-100 pt-1 list-item-word"
                                to={`/block/${block.number}`}>
                            <i className="fa fa-cube mr-2 mt-1 fa_width color-litetokens-100" style={{fontSize:'1rem'}}></i>
                            #{block.number}
                          </Link>
                          <div>
                            <i className="fas fa-exchange-alt mr-2 color-litetokens-100"/>
                            <Link className="color-litetokens-100"
                          ...
                          <div className="text-gray-dark break-word d-flex list-item-word" >
                            ...
                            <AddressLink address={block.witnessAddress} truncate={false}>
                              <span className="color-litetokens-100">{block.witnessName}</span>
                            </AddressLink>
                          </div>
                        ...
                        <div className="ml-auto text-right d-flex flex-column pt-2">
                          ...
                          <div className="text-gray-dark break-word color-grey-200 list-item-word"  style={styles.nowrap}>
                            {tu("block_reward")}: <XLTPrice amount={32}/>
                          </div>
