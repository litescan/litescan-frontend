  ...
  render() {
    ...
    return (
      <div className="card" style={styles.card}>
        <div className="card-header bg-litetokens-light d-flex">
              ...
              <div className="media">
                <div className="media-body mb-0 d-flex">
                  <div className="text-left pt-1">
                    <div className="pt-1">
                      <i className="fa fa-bars mr-2 mt-1 fa_width color-litetokens-100"></i>
                    ...
                    <AddressLink wrapClassName="d-inline-block mr-2" className="color-litetokens-100" address={transfer.transferFromAddress} truncate={false}>
                      {transfer.transferFromAddress.substr(0, 15)}...
                    </AddressLink>
                    <span className="color-grey-300 mr-2">{tu("to")}</span>
                    <AddressLink wrapClassName="d-inline-block mr-2" className="color-litetokens-100" address={transfer.transferToAddress} truncate={false}>
                  ...
                  <div className="ml-auto text-right d-flex flex-column pt-2 list-item-word" style={styles.nowrap}>
                    <div className="color-grey-200" style={{flex:1}}>
                      <XLTPrice amount={transfer.amount} name={transfer.tokenName} source='transfers'/>
                    </div>
