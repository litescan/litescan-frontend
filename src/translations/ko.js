...
export const messages = {
  ...
  */
  ...
  ##################################################################################
  */
  "litetokens_main_message": "네트워크의 새로운 탈중앙화",
  ...
  */
  "addresses": "주소",
  "xlt_transferred_past_hour": "지난 시간 이후로 전송된 XLT",
  "transactions_past_hour": "지난 시간 이후로 시작된 트랜잭션",
  "average_blocksize": "평균 블록 크기",
  "rich_list": "분포 통계",
  "litetokens_transaction_chart": "트론 트랜잭션 차트",
  ...
  */
  ...
  "do_not_send_2": "XLT를 귀하의 지갑이나 거래소에서 위의 테스트넷 계정 주소로 보내지 마십시오!",
  "bandwidth": "대역폭",
  "balance": "잔액",
  "litetokens_power": "트론 파워",
  "transactions": "트랜잭션",
  ...
  "information_message_1": "XLT를 요청할 때 10000 XLT를 받습니다. XLT는 테스트 네트워크에서 테스트하는 데 사용할 수 있습니다.",
  "information_message_2": "XLT는 계정당 한 번만 요청할 수 있습니다.",
  "request_xlt_for_testing": "테스트용 XLT 요청",
  ...
  "current": "현재",
  "xlt_received": "XLT 받음",
  "test_xlt_temporarily_unavailable_message": "테스트용 XLT가 임시적으로 사용 이용불가능합니다. 나중에 다시 시도해주십시오.",
  "not_enough_xlt": "XLT가 충분하지 않습니다",
  "information_message_3": "성공적으로 XLT를 요청하였습니다. 만약 XLT를 받지 못했다면 테스트용 XLT가 남아있지 않은 것이니, 다음에 다시 시도해주십시오.",
  ...
  */
  "freeze": "동결",
  "unfreeze": "동결 해제",
  "freeze_xlt_least": "동결하기 위해서는 최소 1개의 XLT가 필요합니다",
  "unable_unfreeze_xlt_message": "동결 최소 기간이 아직 지나지 않아 XLT를 동결 해제할 수 없습니다.",
  "freeze_xlt_premessage_0": `XLT를 동결 및 잠금 설정하여 트론 파워를 얻고, 추가 기능들을 활성화시킬 수 있습니다. 예를 들면, 트론 파워로 다음이 가능합니다: `,
  "freeze_xlt_premessage_link": "슈퍼 대표(EV)에 투표하기.",
  "freeze_xlt_premessage_1": `동결된 토큰은 3일 동안 "락(locked)" 될 것입니다. 이 기간동안 동결된 XLT는 거래(트레이딩)가 불가능합니다. 이 기간이 지나면, XLT를 동결 해제할 수 있으며 다시 거래를 할 수 있게됩니다.`,
  "xlt_amount": "XLT 수량",
  ...
  "unfreeze_xlt_confirm_message": "정말로 XLT를 동결 해제합니까?",
  ...
  */
  ...
  "apply_for_delegate_description": `
    ...
    최대 투표수는 매번 사용자가 보유한 XLT보다 적거나 같습니다.
    (귀하가 특정 수의 XLT를 가지고 있으면 그 수와 같거나 이하의 투표를 할 수 있습니다)
    투표 결과는 각 투표주기의 각 계정의 최종 유권자 정보를 기반으로 계산되며 시간은 00:00에서 24:00 사이입니다.
     가장 많은 표를 얻은 XLT 소지자는 슈퍼 대표가 됩니다.
  ...
  "do_not_send_1": "XLT를 귀하의 지갑이나 거래소에서 귀하의 테스트넷 주소로 보내지 마십시오!",
  ...
  "success": "성공",
  "successfully_appied_ev_canidate_message_0": "성공적으로 슈퍼 대표(EV) 후보에 신청하였습니다.",
  "successfully_appied_ev_canidate_message_1": "계정이 곧 업그레이드 될 것입니다.",
  "landing_page": "랜딩 페이지",
  "show_more_information_publish_ev_page": "페이지 등록하는 방법 자세히 알아보기",
  "create_ev_landing_page_message_0": "슈퍼 대표(EV)는 랜딩 페이지를 만들어서 팀에 대한 더 많은 정보와 계획을 공유할 수 있습니다",
  ...
  "claim_rewards": "보상 청구",
  "ev_receive_reward_message_0": "대표로서 블록 생성에 대한 보상을 받을 수 있습니다. 이러한 보상은 24시간마다 청구할 수 있습니다",
  "intro": "Intro",
  ...
  */
  ...
  "token_exchange_confirm": "토큰 배포에 {xltAmount}를 사용하여, {tokenAmount}의 토큰을 얻었습니다.",
  ...
  */
  ...
  "for": "을 다음으로 구매:",
  "insufficient_xlt": "불충분한 XLT",
  "not_enough_xlt_message": "토큰을 구매할 수 있는 XLT를 충분히 가지고 있지 않습니다",
  "ends": "마감 기한은",
  "starts": "시작일은",
  ...
  ##################################################################################
  */
  "address_warning": "유효한 LITETOKENS 지갑 주소만 입력하십시오. 잘못된 주소는 XLT 손실을 초래할 수 있습니다.",
  "search_address_or_url": "주소 또는 URL 검색",
  "the_lunch_test": "테스트넷의 출시는 블록 체인 탐색기와 지갑의 모든 기능을 테스트하는 것을 목표로합니다.",
  "please_keep_in_mind": `명심하십시오. 현재 생성한 계정 주소는 오로지 테스트넷을 위한 것입니다. 절대 테스트넷의 주소로 실제 거래소의 XLT나 지갑의 XLT를 전송하지 마십시오.`,
  "litetokens_foundation": "LITETOKENS 재단",
  "xlt_for_testing": "계정 관리를 통해 성공적으로 신청하면 테스트용 XLT가 테스트 계정으로 전송됩니다.",
  "dear_users": "친애하는 사용자,",
  "finished": "종료",
  "token": "토큰",
  "url": "토큰 정보 안내 주소",
  ...
  "no_xlt_remaining": "남아있는 XLT가 없습니다.",
  "show_more": "{countriesLength}개 더보기",
  "vote_guide_message": `XLT를 사용하여 슈퍼 대표(EV)에 투표하십시오.
   귀하가 보유하고있는 모든 XLT에 대해 귀하는 하나의 투표권을가집니다.
   XLT는 소비되지 않습니다. 원하는대로 여러 대표에게 여러 번 투표 할 수 있습니다.
  ...
  */
  ...
  "exchange_rate_message_0": "참여자가 매 XLT마다 받을 수 있는 토큰의 개수를 정의하기 위해 토큰의 개별 가격을 지정하십시오.",
  "exchange_rate_message_1": "참여자는 다음과 같이 받습니다:",
  "exchange_rate_message_2": "마다",
  "exchange_rate_message_3": "XLT",
  "participation_message_0": "토큰 발행이 이루어지는 참여 기간을 설정하십시오. 참여 기간동안 사용자들은 XLT를 ",
  ...
  "token_issue_guide_message_3":`토큰을 발행하면 계정에 총 공급과 동일한 토큰 금액이 지급됩니다.
   다른 사용자가 XLT를 토큰으로 교환하면 토큰이 계정에서 철회되고 지정된 환율과 동일한 XLT를 받게됩니다.`,
  /*
  ##################################################################################
  #                                                                                #
  ...
  */
  ...
  "litetokens_value_error": "XLT 수량은 최소 1입니다",
  ...
  */
  ...
  "warning_votes": "투표하기 위해서는 최소 1 트론 파워(TP)가 필요합니다. 트론 파워는 XLT를 동결시켜 얻을 수 있고 다음에서 할 수 있습니다:",
  "account_page": "계정 페이지",
  ...
  "need_min_xlt_to_vote_message": "투표하기 위해서는 최소 1XLT가 필요합니다니",
  ...
  */
  ...
  ##################################################################################
  */
  "what_is_litetokens": "트론의 정의",
  "litetokens_explorer_api": "트론 탐색기 API",
  "litetokens_architechure": "트론 아키텍처",
  "litetokens_protobuf_doc": "트론 프로토콜 버퍼 문서(Protobuf)",
  ...
  */
  ...
  "open_the_litescan_desktop_client": "트론스캔(Litescan) 데스크톱 클라이언트를 실행합니다",
  ...
  "open_litetokens_app_on_ledger": "레저에서 트론 앱을 실행하세요",
  "ledger_connected_litescan_message_0": "레저가 정상적으로 연결되었다면 트론스캔에 '연결됨(Connected)'가 나타날 것입니다",
  ...
  "using_ledger_to_sign_transactions_message_1": "트랜잭션 서명이 필요할 때 트론스캔이 트랜잭션의 세부 내용을 팝업으로 알려줄 것입니다. 서명은 사용자가 투표, XLT전송, 계정 이름 변경 등의 행위를 할 때마다 필요합니다.",
  /*
  ##################################################################################
  #                                                                                #
  ...
  */
  ...
  "XLT_transfer_between_addresses": "주소 간에 XLT 이동",
  ...
  "updates_a_witness": "증인(EV) 정보 업데이트",
  "witness_create_contract": "Witness Create Contract",
  "create_a_witness": "증인(EV) 생성",
  ...
  "unfreeze_XLT": "XLT 동결 해제",
  "vote_witness_contract": "Vote Witness Contract",
  "vote_for_a_witness": "증인(EV)에 투표합니다",
