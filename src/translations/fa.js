...
export const messages = {
  ...
  */
  ...
  "xlt_token_fee_message": "1024000 تی آر ایکس برای صدور یک توکن جدید لازم است",
  ...
  */
  ...
  "token_spend_confirm": "من تأیید میکنم که باید 1024000 ترون را برای ساختن توکن خرج کنم",
  "token_issue_guide_message_1":`صدور توکن در پروتکل LITETOKENS می تواند انجام شود توسط هر کسی که حداقل 1024000 XLT را در حساب خود داشته باشد.`,
