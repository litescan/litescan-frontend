export const messages = {
  ...
  */
  "addresses": "addresses",
  "xlt_transferred_past_hour": "XLT transferred in the past hour",
  ...
  */
  ...
  "do_not_send_2": "Do not send XLT from your own wallet or exchange to the above account address of testnet!",
  "bandwidth": "bandwidth",
  "balance": "Balance",
  ...
  "information_message_1": "Mainnet cannot request testing xlt, please contact LITETOKENS to get test xlt.",
  "information_message_2": "You may only request XLT 10 times per account.",
  "request_xlt_for_testing": "Request XLT for testing",
  ...
  "network": "network",
  "current": "current",
  "xlt_received": "XLT received",
  "test_xlt_temporarily_unavailable_message": "Test XLT is temporarily unavailable. Please try again later.",
  "not_enough_xlt": "Not enough XLT",
  ...
  */
  "freeze": "freeze",
  "unfreeze": "unfreeze",
  "freeze_xlt_least": "You need at least 1 XLT to be able to freeze",
  ...
  "unfreeze_xlt_confirm_message": "Are you sure you want to unfreeze XLT?",
  ...
  */
  ...
  "token_exchange_confirm": "I've confirmed to spend {xltAmount} on token distribution, and get a total of {tokenAmount} tokens.",
  ...
  */
  ...
  "not_enough_xlt_message": "You do not have enough XLT to buy so many tokens",
  "ends": "ends",
  "starts": "starts",
  ...
  */
  ...
  "please_keep_in_mind": "Please keep in mind, that since your registered account address is only used for testnet, do not send XLT from your own wallet or exchange to the account address of testnet.",
  "litetokens_foundation": "LITETOKENS Foundation",
  "xlt_for_testing": "XLT for testing will be sent to your testing account once you successfully apply through account management.",
  ...
  */
  ...
  "exchange_rate_message_0": "Specify the price of a single token by defining how many tokens a participant will receive for every XLT they spend.",
  "exchange_rate_message_1": "Participants will receive",
  "exchange_rate_message_2": "for every",
  "exchange_rate_message_3": "XLT",
  "participation_message_0": "Specify the participation period in which tokens will be issued. During the participation period users can exchange XLT for ",
  ...
  "token_issue_guide_message_3": `After issuing the token your account will receive the amount of tokens equal to the total supply.
    When other users exchange their XLT for tokens then the tokens will be withdrawn from your account and you will
    receive XLT equal to the specified exchange rate.`,
  /*
  ##################################################################################
  #                                                                                #
  ...
  */
  ...
  "litetokens_value_error": "The amount of XLT per coin must be at least 1",
  ...
  */
  ...
  "warning_votes": "At least 1 LITETOKENS Power is required to start voting. LITETOKENS Power is gained by freezing XLT on the",
  ...
  "need_min_xlt_to_vote_message": "You need at least 1 XLT to be able to vote",
  ...
  */
  ...
  ##################################################################################
  */
  "what_is_litetokens": "What is LITETOKENS",
  "litetokens_explorer_api": "LITETOKENS Explorer API",
  "litetokens_architechure": "LITETOKENS Architecture",
  "litetokens_protobuf_doc": "LITETOKENS Protobuf Documentation",
  ...
  */
  ...
  "do_not_lose_it_message_0": "LITETOKENS Foundation cannot help you recover a lost key.",
  ...
  */
  "buy_xlt": "Buy XLT",
  "buy_xlt_message_0": "XLT can be purchased directly with Fiat or other Crypto-Currencies without a stock exchange. It uses a service from Changelly.com and is the easiest and fastest way to purchase xlt. A list of supported currencies and a FAQ can be found at ",
  "buy_xlt_using_changelly": "Buy XLT using Changelly",
  ...
  */
  ...
  ##################################################################################
*/
  "LITETOKENSRating": "LITETOKENS Token Rating",
  "rating_title": "Litescan Token Reputation System",
  "modify_on": "Modified on",
  "rating_description": "The Litescan Reputation System aims at helping users to understand, differentiate and assess different tokens. When you visit the token page, the Reputation is classified into 5 categories:",
  ...
  "disclaimer_desc_1": "Litescan does not endorse, approve or condemn any services or projects related to the token contracts displayed on the Litescan. Users should always conduct research with due diligence before taking any action related to the token, especially when it comes to value investing.",
...
*/
  ...
  "litetokens_rating":"Token Reputation",
  "my_token_desc_2": "If you need to update your information, please send the updates using the following Excel template to token@litetokens.org via your company email or certified email with necessary credentials.",
...
*/
  ...
  "token_overview_litetokens":"Overview of LITETOKENS token market",
  "token_participate_litetokens":"Participate in LITETOKENS token issuance",
